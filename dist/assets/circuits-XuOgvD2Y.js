import"./buttons-DmxYQrBH.js";import{r as n,a as o,i as d}from"./render-home-XFWJLOTR.js";/* empty css                 */import{getAllCircuitsPageData as l,allCircuitsPageMeta as p}from"./circuits-page-data-Rimbap15.js";import{i as u}from"./scroll-reveal-DRkjB4s9.js";import"./paths-pBgruvT_.js";import"./safari-packages-Bwk-a-Z1.js";function t(a){const e=document.createElement("div");return e.textContent=a??"",e.innerHTML}function _(a,e){const i=e%3;return`
  ...
  `}function h(){const a=l(),e=p;document.title=`${e.title} | Matembo Safari & Tours`;const i=document.querySelector('meta[name="description"]');i&&i.setAttribute("content",e.lead);const r=document.querySelector("#circuits-hero-root"),c=document.querySelector("#circuits-grid-root");r&&(r.innerHTML=`
    ...
    `),c&&(c.innerHTML=a.map(_).join(""))}function s(){try{n(),o(),h(),d()}catch(a){console.error("Matembo circuits page init failed:",a)}finally{u()}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",s):s();
