import{v as u,w as g,x as d}from"./render-home-DkvHZ7K0.js";import"./paths-BeSZcpY7.js";import"./scroll-reveal-6DLuizO8.js";import"./destinations-data-DBODsxHG.js";function s(e){const a=document.createElement("div");return a.textContent=e,a.innerHTML}function c(e,a,t,n,m=""){return e?`<img
    class="${a}"
    src="${s(e)}"
    alt="${s(m)}"
    width="${t}"
        ...
        <li class="mega-menu__list-item">
          <a class="mega-menu__list-link" href="${s(a.href)}">
            ${a.image?`<span class="mega-menu__list-thumb-wrap">
                    ${c(a.image,"mega-menu__list-thumb",52,52)}
                  </span>`:""}
  ...
  `:""}function $(e,a=""){const{featured:t,heading:n,items:m,aside:i,footer:l}=e,o=!!t,r=o?`
      <a class="mega-menu__spotlight" href="${s(t.href)}">
        <span class="mega-menu__spotlight-media">
          ${c(t.image,"",320,400,t.alt||t.name)}
    ...
    `:"";return`
    <div class="mega-menu mega-menu--editorial${o?"":" mega-menu--no-spotlight"}${a?` ${a}`:""}">
  ...
  `}async function y(e=document){const a=e instanceof Document?e:e.ownerDocument||document;if(a.documentElement.dataset.megaHydrated)return;a.documentElement.dataset.megaHydrated="1";const t=[...a.querySelectorAll("[data-mega-slot]")];if(t.length){for(const n of t){const m=n.getAttribute("data-mega-slot"),i=d[m];if(!i)continue;const l=m==="about"?"mega-menu--about":"";n.insertAdjacentHTML("beforeend",$(i,l)),n.removeAttribute("data-mega-slot"),n.setAttribute("data-mega","")}u(a),g()}}export{y as hydrateMegaMenus};
