import{h as g,j as y,r as $,a as w,i as p}from"./render-home-DLbeZLdX.js";import{initSlideshows as x}from"./slideshow-CpJtcc9p.js";import{a as E,i as k}from"./scroll-reveal-BPEmY50i.js";function s(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function S(t){return`/destinations/${encodeURIComponent(t.id)}.html`}const m=["serengeti","ngorongoro","kilimanjaro","tarangire","manyara","arusha"],A=["ruaha","nyerere","katavi","kitulo","lake-nyasa","matema-beach","isimila","mikumi"],R=["mikumi","udzungwa","saadani","kilwa-kisiwani","bagamoyo","pangani"],D=["mahale","gombe","rubondo","lake-tanganyika","saanane"],L=["zanzibar","stone-town","jozani-forest","nungwi-beach","pemba","chumbe-island"],T=["mafia","chole-bay","juani-island","misali-island"],N=["pemba","misali-island","fanjove-island","chumbe-island","mnemba-island","thanda-island"],P={southern:A,eastern:R,western:D,northern:m,zanzibar:L,mafia:T,oceanic:N};function U(t,e=3){const a=g(t),i=(a==null?void 0:a.circuit)||"northern",n=P[i]||m,o=y.filter(d=>d.circuit===i),r=[],c=new Set([t]);for(const d of n){if(r.length>=e)break;if(c.has(d))continue;const h=g(d);h&&h.circuit===i&&(r.push(h),c.add(d))}for(const d of o){if(r.length>=e)break;c.has(d.id)||(r.push(d),c.add(d.id))}return r}function v(t){var n;const e=(n=t.gallery)!=null&&n.length?t.gallery:t.images,a=new Set,i=[];for(const o of e)if(!(!(o!=null&&o.src)||a.has(o.src))&&(a.add(o.src),i.push(o),i.length>=12))break;return i}function j(t,e){return t.map((a,i)=>`
  ...
  `:""}function F(t){var a;return((a=t.descriptions)!=null&&a.length?t.descriptions:[t.description]).filter(Boolean).map((i,n)=>n===0?`<p class="dest-page__lead">${s(i)}</p>`:`<p class="dest-page__text">${s(i)}</p>`).join("")}function I(t){return t.length?`
      ...
      <section class="dest-page__content">
        <div class="container">
          ...
          <div class="dest-page__main section-reveal">
            ...
            <div class="dest-page__copy">${F(e)}</div>
          </div>
        </div>
      </section>
