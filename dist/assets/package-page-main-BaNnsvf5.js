import{b as _,s as u}from"./safari-packages-CU_z_aDq.js";import{a as v,s as h,b as m}from"./content-utils-YZbAt33H.js";import{r as k,a as f,i as d}from"./render-home-BvSrwE3U.js";import{initSlideshows as $}from"./slideshow-BEvNnOa7.js";import{i as y}from"./scroll-reveal-BxdqyS58.js";import{initCardTilt as b}from"./card-tilt-C-GpDV49.js";function i(a){const e=document.createElement("div");return e.textContent=a??"",e.innerHTML}function w(a){const e=typeof a=="string"?a:a.id;return`/packages/${encodeURIComponent(e)}.html`}function S(a){return a.safariType||a.circuit||"Safari Package"}function x(a){var o;const e=h(a.overview),t=m(a.overview,a.activities),n=e.slice(0,3).map((s,r)=>r===0?`<p class="pkg-section__text pkg-section__text--lead">${i(s)}</p>`:`<p class="pkg-section__text">${i(s)}</p>`).join(""),l=t.length>0?`
  ...
  `:""}function j(a,e=3){const t=_(a),n=t==null?void 0:t.circuit,l=u.filter(r=>r.id!==a);return[...l.filter(r=>r.circuit===n),...l.filter(r=>r.circuit!==n)].slice(0,e)}function I(a,e){var r;const t=document.querySelector(a);if(!t||!e)return!1;const{hero:n,extras:l}=v(e,3),o=j(e.id,3);document.title=`${e.title} | Matembo Safari & Tours`;const s=document.querySelector('meta[name="description"]');return s&&s.setAttribute("content",((r=h(e.overview)[0])==null?void 0:r.slice(0,155))||`${e.title} – ${e.duration} safari with Matembo Safari & Tours.`),t.innerHTML=`
