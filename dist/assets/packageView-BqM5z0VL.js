import"./buttons-r323SqNs.js";/* empty css             */import{a as h,g as d}from"./safari-packages-CU_z_aDq.js";import{initSlideshows as y}from"./slideshow-B52kY28T.js";import{i as m}from"./scroll-reveal-6DLuizO8.js";const o="2-days-to-tarangire-national-park-ngorongoro-crater";function _(a){return d(a)??d(o)??h[0]}_(o);function e(a){const t=document.createElement("div");return t.textContent=a??"",t.innerHTML}function b(){const a=new URLSearchParams(window.location.search).get("id");return _(a)}function v(a){return a.safariType||a.circuit||"Safari Package"}function p(a,t="",s){return a!=null&&a.length?a.map((i,l)=>`
