const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/mega-menu-hydrate-sUkU5zfU.js","assets/paths-BeSZcpY7.js","assets/scroll-reveal-BxdqyS58.js","assets/destinations-data-DBODsxHG.js","assets/content-utils-YZbAt33H.js","assets/circuits-page-data-BmmBrAjf.js","assets/safari-packages-CU_z_aDq.js"])))=>i.map(i=>d[i]);
import{_ as z,p as L}from"./paths-BeSZcpY7.js";import{l as _e}from"./scroll-reveal-BxdqyS58.js";import{g as ce}from"./destinations-data-DBODsxHG.js";import{e as p,f as l}from"./content-utils-YZbAt33H.js";const ve="/assets/about/descriptions.jpg",be="/assets/about/Matembo logo.jpg",Z={name:"Matembo Safari & Tours",tagline:"Safari & Tours"},we=[{label:"Home",href:"/",plain:!0},{label:"Destinations",href:"/circuits.html",megaKey:"destinations"},{label:"Safaris",href:"/safaris.html",megaKey:"safaris"},{label:"Things to Do",href:"/experiences.html",megaKey:"thingsToDo"},{label:"Ruaha",href:"/ruaha-safaris.html",megaKey:"ruaha"},{label:"About Us",href:"/about.html",megaKey:"about"}],Y="/assets/about/main3.jpg",ye={ruaha2d:"/assets/photos/Ruaha_National_Park_Ruaha_River_42.jpg",ruaha3d:"/assets/photos/Ruaha_National_Park_Ruaha_River_39.jpg",ruaha4d:"/assets/photos/Ruaha_National_Park_Hippos_47.jpg",ruaha5d:"/assets/photos/Ruaha_National_Park_Elephants_49.jpg",ruaha7d:"/assets/photos/Udzungwa_National_Park_Sanje_Waterfalls_21.jpg",ruaha10d:"/assets/photos/Nyerere_National_Park_Lions_102.jpg",serengeti3d:"/assets/photos/Serengeti_Wildebeests_03.jpg",ngorongoroDay:"/assets/photos/Ngorongoro_Crater_01_NCA.jpg",tarangireDay:"/assets/photos/Tarangire_National_Park_Lions_20.jpg",serengeti5d:"/assets/photos/Serengeti_National_Park_Wildebeests_20.jpg",lemosho7d:"/assets/photos/Kilimanjaro_Trek_Lemosho_Route_04.jpg",machame8d:"/assets/photos/Kilimanjaro_Climb_Machame_Route_03.jpg",shiraDay:"/assets/photos/Kilimanjaro_Climb_Shira_Plateau_02.jpg",walkingSafaris:"/assets/about/walking safaris.jpg",migration:"/assets/photos/Serengeti_Wildebeests_03.jpg",olduvai:"/assets/photos/Olduvai_Gorge_NCA_2_1.jpg",udzungwa:"/assets/photos/Udzungwa_National_Park_Sanje_Waterfalls_21.jpg"};function ke(e){const a=e.getAttribute("data-fallback")||Y;e.dataset.fallbackApplied||(e.dataset.fallbackApplied="1",e.src=a)}function Se(e=document){e.querySelectorAll(".mega-menu img, .site-header__brand-emblem").forEach(a=>{a.dataset.fallbackBound||(a.dataset.fallbackBound="1",a.addEventListener("error",()=>{if(a.hasAttribute("data-src"))return;const i=a.dataset.srcOriginal;if(i&&a.src.includes("/images/made/")&&!a.dataset.retriedOriginal){a.dataset.retriedOriginal="1",a.src=i;return}if(i&&!a.dataset.retriedOriginal&&a.src!==i){a.dataset.retriedOriginal="1",a.src=i;return}ke(a)}))})}function T(e){const a=document.createElement("div");return a.textContent=e,a.innerHTML}function Me(e){if(e.plain)return`
      <li class="site-nav__item">
        <a class="site-nav__trigger site-nav__trigger--plain" href="${T(e.href)}">${T(e.label)}</a>
      </li>
    `;const a=e.href?"a":"button",i=e.href?` href="${T(e.href)}"`:"",r=e.href?"":' type="button"';return`
    <li class="site-nav__item" data-mega-slot="${T(e.megaKey)}">
      <${a}
  ...
  `}function Ae(){const e=we.map(Me).join("");return`
    <header class="site-header is-over-hero" data-site-header>
      <div class="site-header__bar">
        <div class="container site-header__inner">
          <a class="site-header__brand" href="/" aria-label="${T(Z.name)} home">
            ...
            <span class="site-header__brand-lockup">
              ...
              <span class="site-header__brand-sub">${T(Z.tagline)}</span>
            </span>
          </a>
  ...
  `}function Xe(e,a){return`
    ...
    >
      ...
      <a href="${ge(e.cta.href)}" class="btn btn--ghost hero-showcase__cta">${l(e.cta.label)}</a>
    </article>
  `}function ea(e,a){return`
    <button
      type="button"
  ...
  `}function fe(e=document.querySelector("#home-hero")){const a=e==null?void 0:e.querySelector("[data-hero-slideshow]");if(!a)return;const i=a.querySelector(".hero-showcase__slides"),r=a.querySelector(".hero-showcase__panels"),o=a.querySelector(".hero-showcase__dots"),n=a.querySelector("[data-hero-counter]"),c=a.querySelector("[data-hero-progress]");if(!i||!r||!o)return;const s=i.querySelectorAll("[data-hero-slide]").length;if(s>=w.length)return;const h=String(w.length).padStart(2,"0");for(let _=s;_<w.length;_++)i.insertAdjacentHTML("beforeend",Qe(w[_],_)),r.insertAdjacentHTML("beforeend",Xe(w[_],_)),o.insertAdjacentHTML("beforeend",ea(w[_],_));n&&(n.textContent=`01 / ${h}`),c&&(c.style.width=`${Math.round(100/w.length)}%`)}function aa(){var c;const e=document.querySelector("#home-hero");if(!e)return;if(e.querySelector("[data-hero-slideshow]")){fe(e);return}(c=e.querySelector("#hero-lcp-bootstrap"))==null||c.remove();const a=String(w.length).padStart(2,"0"),i=w.map((s,h)=>`
      ...
      `).join(""),r=Array.from({length:5},(s,h)=>`<span class="hero-showcase__particle" style="--i:${h}"></span>`).join(""),o=w.map((s,h)=>`
        ...
        >
          ...
          <a href="${ge(s.cta.href)}" class="btn btn--ghost hero-showcase__cta">${l(s.cta.label)}</a>
        </article>
      `).join(""),n=w.map((s,h)=>`
        <button
          type="button"
  ...
  `}function ta(){const e=document.querySelector("#home-about");e&&(e.innerHTML=`
  ...
  `)}function ia(){const e=document.querySelector("#home-experiences");e&&(e.innerHTML=`
    <section class="home-experiences" id="experiences" aria-labelledby="experiences-title">
      <div class="container">
        <header class="home-section__header section-reveal">
          ...
          <p class="home-section__desc">${l(Ue)}</p>
        </header>
  ...
  `)}function ra(){const e=document.querySelector("#home-credentials");e&&(e.innerHTML=`
  ...
  `)}function sa(){const e=document.querySelector("#home-testimonials");e&&(e.innerHTML=`
    <section class="home-testimonials" id="testimonials" aria-labelledby="testimonials-title">
      <div class="container">
        <header class="home-section__header section-reveal">
          ...
          <p class="home-section__desc">${l(Ze)} <a href="${p(E)}" target="_blank" rel="noopener noreferrer"><i class="fab fa-tripadvisor" aria-hidden="true"></i> TripAdvisor</a>.</p>
        </header>

        <div class="testimonials-grid">
          ${Ye.map((a,i)=>`
                <blockquote class="testimonial-card" data-reveal ${i?`data-reveal-delay="${i}"`:""}>
                  <div class="testimonial-card__stars" aria-label="${a.rating} out of 5 stars">${Je(a.rating)}</div>
  ...
  `)}function oa(){const e=document.querySelector("#home-contact");e&&(e.innerHTML=`
    <section class="home-contact" id="contact" aria-labelledby="contact-title">
      <div class="container home-contact__inner section-reveal">
        <span class="home-contact__script">${l(x.signature)}</span>
        <h2 id="contact-title" class="home-contact__title">${l(x.title)}</h2>
        <p class="home-contact__text">${l(x.text)}</p>
        <div class="home-contact__actions">
          <a href="${p(x.ctaPrimary.href)}" class="btn btn--primary">${l(x.ctaPrimary.label)}</a>
          <a href="${p(x.ctaSecondary.href)}" class="btn btn--secondary" target="_blank" rel="noopener noreferrer">${l(x.ctaSecondary.label)}</a>
        </div>
        <p class="home-contact__meta">${l($.location)} · ${l($.phone)}</p>
      </div>
    </section>
  `)}function na(){const e=document.querySelector("#site-footer");if(!e)return;const a=Fe.map(i=>`
        <a
      ...
      <div class="site-footer__top">
        <div class="container site-footer__grid">
          ...
          <nav class="site-footer__col" aria-label="Plan your trip">
            ...
            <a class="site-footer__link" href="${p(E)}" target="_blank" rel="noopener noreferrer">
  ...
  `}const va=Object.freeze(Object.defineProperty({__proto__:null,enhanceHeroSlideshow:fe,renderAbout:ta,renderContactCta:oa,renderCredentials:ra,renderExperiences:ia,renderHero:aa,renderSiteFooter:na,renderTestimonials:sa},Symbol.toStringTag,{value:"Module"}));export{F as D,ye as N,na as a,$ as b,_a as c,x as d,D as e,ue as f,j as g,V as h,ga as i,He as j,ma as k,aa as l,Se as m,fa as n,$e as o,pa as p,va as q,da as r,Fe as s,de as w};
