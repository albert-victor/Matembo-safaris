import{getSafariPackageById as _,safariPackages as u}from"./safari-packages-DmAoeZIg.js";import{a as v,s as h,e as m}from"./content-utils-B_0c1a9b.js";import{r as k,a as f,i as p}from"./render-home-C8iai7iV.js";import{i as y}from"./slideshow-CPyakMWZ.js";import{i as $}from"./scroll-reveal-DQEng0_I.js";import{i as b}from"./card-tilt-DGI_hcNQ.js";function i(e){const a=document.createElement("div");return a.textContent=e??"",a.innerHTML}function w(e){const a=typeof e=="string"?e:e.id;return`/packages/${encodeURIComponent(a)}.html`}function S(e){return e.safariType||e.circuit||"Safari Package"}function x(e){var o;const a=h(e.overview),t=m(e.overview,e.activities),n=a.slice(0,3).map((s,r)=>r===0?`<p class="pkg-section__text pkg-section__text--lead">${i(s)}</p>`:`<p class="pkg-section__text">${i(s)}</p>`).join(""),l=t.length>0?`
