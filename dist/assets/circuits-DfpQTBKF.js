import"./buttons-DlXGXn9P.js";import{r as n,a as o,i as d}from"./render-home-miLWeeLX.js";/* empty css                 */import{getAllCircuitsPageData as l,allCircuitsPageMeta as p}from"./circuits-page-data-BwYXbWhr.js";import{a as u,i as _}from"./scroll-reveal-B17FauD6.js";import"./preload-helper-DsQV4sYi.js";import"./safari-packages-Bwk-a-Z1.js";function t(a){const e=document.createElement("div");return e.textContent=a??"",e.innerHTML}function m(a,e){const i=e%3;return`
  ...
  `}function h(){const a=l(),e=p;document.title=`${e.title} | Matembo Safari & Tours`;const i=document.querySelector('meta[name="description"]');i&&i.setAttribute("content",e.lead);const r=document.querySelector("#circuits-hero-root"),c=document.querySelector("#circuits-grid-root");r&&(r.innerHTML=`
    ...
    `),c&&(c.innerHTML=a.map(m).join(""))}function s(){try{n(),o(),h(),d(),u()}catch(a){console.error("Matembo circuits page init failed:",a)}finally{_()}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",s):s();
