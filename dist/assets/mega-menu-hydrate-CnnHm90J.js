import{u as r,v as g,w as d}from"./render-home-DLbeZLdX.js";import"./paths-BeSZcpY7.js";import"./scroll-reveal-BPEmY50i.js";function s(e){const a=document.createElement("div");return a.textContent=e,a.innerHTML}function c(e,a,t,n,m=""){return e?`<img
    class="${a}"
    src="${s(e)}"
    alt="${s(m)}"
    width="${t}"
  ...
  `:""}function $(e,a=""){const{featured:t,heading:n,items:m,aside:i,footer:l}=e,o=!!t,u=o?`
  ...
  `}async function v(e=document){const a=e instanceof Document?e:e.ownerDocument||document;if(a.documentElement.dataset.megaHydrated)return;a.documentElement.dataset.megaHydrated="1";const t=[...a.querySelectorAll("[data-mega-slot]")];if(t.length){for(const n of t){const m=n.getAttribute("data-mega-slot"),i=d[m];if(!i)continue;const l=m==="about"?"mega-menu--about":"";n.insertAdjacentHTML("beforeend",$(i,l)),n.removeAttribute("data-mega-slot"),n.setAttribute("data-mega","")}r(a),g()}}export{v as hydrateMegaMenus};
