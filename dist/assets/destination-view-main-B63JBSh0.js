import{a as g,b as y}from"./destinations-data-D-DgQGhw.js";import{r as $,a as w,i as p}from"./render-home-V4yjOGkn.js";import{initSlideshows as x}from"./slideshow-B52kY28T.js";import{a as E,i as k}from"./scroll-reveal-6DLuizO8.js";function s(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function S(t){return`/destinations/${encodeURIComponent(t.id)}.html`}const m=["serengeti","ngorongoro","kilimanjaro","tarangire","manyara","arusha"],A=["ruaha","nyerere","katavi","kitulo","lake-nyasa","matema-beach","isimila","mikumi"],R=["mikumi","udzungwa","saadani","kilwa-kisiwani","bagamoyo","pangani"],D=["mahale","gombe","rubondo","lake-tanganyika","saanane"],L=["zanzibar","stone-town","jozani-forest","nungwi-beach","pemba","chumbe-island"],T=["mafia","chole-bay","juani-island","misali-island"],N=["pemba","misali-island","fanjove-island","chumbe-island","mnemba-island","thanda-island"],P={southern:A,eastern:R,western:D,northern:m,zanzibar:L,mafia:T,oceanic:N};function U(t,e=3){const a=g(t),i=(a==null?void 0:a.circuit)||"northern",n=P[i]||m,o=y.filter(d=>d.circuit===i),r=[],c=new Set([t]);for(const d of n){if(r.length>=e)break;if(c.has(d))continue;const h=g(d);h&&h.circuit===i&&(r.push(h),c.add(d))}for(const d of o){if(r.length>=e)break;c.has(d.id)||(r.push(d),c.add(d.id))}return r}function v(t){var n;const e=(n=t.gallery)!=null&&n.length?t.gallery:t.images,a=new Set,i=[];for(const o of e)if(!(!(o!=null&&o.src)||a.has(o.src))&&(a.add(o.src),i.push(o),i.length>=12))break;return i}function F(t,e){return t.map((a,i)=>`
  ...
  `:""}function I(t){var a;return((a=t.descriptions)!=null&&a.length?t.descriptions:[t.description]).filter(Boolean).map((i,n)=>n===0?`<p class="dest-page__lead">${s(i)}</p>`:`<p class="dest-page__text">${s(i)}</p>`).join("")}function j(t){return t.length?`
  ...
  `:""}function q(t){return t.map(e=>`
      ...
      `).join("")}function z(t,e){const a=document.querySelector(t);if(!a||!e)return!1;const i=v(e),n=i[0],o=U(e.id,3);document.title=`${e.fullName} | Matembo Safari & Tours`;const r=document.querySelector('meta[name="description"]');return r&&r.setAttribute("content",e.description),a.innerHTML=`
