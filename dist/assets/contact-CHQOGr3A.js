import"./buttons-DmxYQrBH.js";import{b as c,r as v,a as $,i as S}from"./render-home-XFWJLOTR.js";import{r as w}from"./render-home-sections-CbsBJMEI.js";import{i as q}from"./scroll-reveal-DRkjB4s9.js";import"./paths-pBgruvT_.js";import"./render-cards-5dEEQBsT.js";import"./safari-packages-Bwk-a-Z1.js";function o(a){const e=document.createElement("div");return e.textContent=a,e.innerHTML}function s(a,e){return`
  ...
  `)}function W(){const a=document.querySelector("#safari-enquiry-form");if(!a)return;const e=new Date().toISOString().split("T")[0],t=a.querySelector('[name="arrival"]'),i=a.querySelector('[name="departure"]');t==null||t.setAttribute("min",e),i==null||i.setAttribute("min",e),t==null||t.addEventListener("change",()=>{t.value&&(i==null||i.setAttribute("min",t.value))}),a.addEventListener("submit",p=>{p.preventDefault();const n=new FormData(a),f=n.get("arrival"),m=n.get("departure"),u=n.get("name"),_=n.get("email"),h=n.get("phone")||"Not provided",r=n.get("safariType"),l=n.get("groupSize"),b=n.get("message")||"",y=encodeURIComponent(`Safari enquiry – ${r} (${l})`),g=encodeURIComponent(`Name: ${u}
Email: ${_}
Phone: ${h}
