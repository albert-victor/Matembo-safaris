import{_ as f,p as v}from"./preload-helper-DsQV4sYi.js";function e(a){const i=document.createElement("div");return i.textContent=a,i.innerHTML}function m(a){return String(a+1).padStart(2,"0")}function b(a){return(a.matemboPitch?[a.matemboPitch,...a.highlights||[]]:a.highlights||[]).slice(0,3).map(t=>`<li class="safari-card__highlight">${e(t)}</li>`).join("")}function g(a,i,t={}){const n=t.viewLabel||"View Safari",l=a.matemboLabel||a.title,c=!!t.inCarousel,r=c?0:i%3,d=a.badge?`<span class="safari-card__badge">${e(a.badge)}</span>`:"",s=a.objectPosition||"center center",o=i%2===0?"green":"gold",h=m(i),_=i<3,u=_?`src="${e(a.image)}" class="safari-card__image is-loaded"${i===0?' fetchpriority="high"':""}`:`data-src="${e(a.image)}" src="" class="safari-card__image"`;return`
        ...
        <div class="safari-card__inner">
          ...
          <div class="safari-card__body">
            ...
            <div class="safari-card__actions">
              <a href="${v(a)}" class="btn btn--primary btn--card">${e(n)}</a>
  ...
  `}async function p(a,i={}){const t=typeof a=="string"?document.querySelector(a):a;if(!t)return;const{ids:n,packages:l,viewLabel:c}=i;let r=l;if(!(r!=null&&r.length)){const{safariPackages:d}=await f(async()=>{const{safariPackages:s}=await import("./safari-packages-DmAoeZIg.js");return{safariPackages:s}},[]);r=d}if(n!=null&&n.length){const{safariPackages:d}=await f(async()=>{const{safariPackages:s}=await import("./safari-packages-DmAoeZIg.js");return{safariPackages:s}},[]);r=n.map(s=>d.find(o=>o.id===s)).filter(Boolean)}t.innerHTML=r.map((d,s)=>g(d,s,{viewLabel:c})).join("")}export{g as a,p as r};
