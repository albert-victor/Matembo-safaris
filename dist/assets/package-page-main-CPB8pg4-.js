import{getSafariPackageById as _,safariPackages as u}from"./safari-packages-DmAoeZIg.js";import{a as v,s as h,e as m}from"./content-utils-B_0c1a9b.js";import{r as k,a as f,i as p}from"./render-home-DLbeZLdX.js";import{initSlideshows as y}from"./slideshow-CpJtcc9p.js";import{i as $}from"./scroll-reveal-BPEmY50i.js";import{initCardTilt as b}from"./card-tilt-BnDLqkLY.js";function i(e){const a=document.createElement("div");return a.textContent=e??"",a.innerHTML}function w(e){const a=typeof e=="string"?e:e.id;return`/packages/${encodeURIComponent(a)}.html`}function S(e){return e.safariType||e.circuit||"Safari Package"}function x(e){var o;const a=h(e.overview),t=m(e.overview,e.activities),n=a.slice(0,3).map((s,r)=>r===0?`<p class="pkg-section__text pkg-section__text--lead">${i(s)}</p>`:`<p class="pkg-section__text">${i(s)}</p>`).join(""),l=t.length>0?`
  ...
  `)}function M(){const e=document.body.dataset.packageId;return e||new URLSearchParams(window.location.search).get("id")||""}function g(){try{k(),f();const e=M(),a=_(e);if(!a){q("#package-view-root"),p();return}L("#package-view-root",a),p(),y(),b()}catch(e){console.error("Matembo package page init failed:",e)}finally{$()}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",g):g();
