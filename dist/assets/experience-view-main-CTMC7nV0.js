import{k as b,l as m,r as f,a as y,i as x,o as $}from"./render-home-C8iai7iV.js";import{p as w,d as k,s as E}from"./content-utils-B_0c1a9b.js";import{i as S}from"./slideshow-CPyakMWZ.js";import{i as _}from"./scroll-reveal-DQEng0_I.js";import{r as P}from"./render-cards-BbVXQDY5.js";import{a as L,g as C}from"./activity-packages-BjfvwCku.js";import{i as A}from"./card-tilt-DGI_hcNQ.js";function r(t){const e=document.createElement("div");return e.textContent=t,e.innerHTML}function v(t){return w(t,4)}function q(t,e=3){const a=[],i=new Set([t]);for(const s of b){if(a.length>=e)break;i.has(s.id)||(a.push(s),i.add(s.id))}return a}function T(t,e=3){return t!=null&&t.length?`
