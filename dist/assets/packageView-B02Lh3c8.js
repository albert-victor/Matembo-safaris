import"./buttons-DmxYQrBH.js";/* empty css             */import{safariPackages as h,getSafariPackageById as d}from"./safari-packages-Bwk-a-Z1.js";import{i as y}from"./slideshow-DONQcubt.js";import{i as m}from"./scroll-reveal-DRkjB4s9.js";const o="2-days-to-tarangire-national-park-ngorongoro-crater";function _(a){return d(a)??d(o)??h[0]}_(o);function e(a){const t=document.createElement("div");return t.textContent=a??"",t.innerHTML}function b(){const a=new URLSearchParams(window.location.search).get("id");return _(a)}function v(a){return a.safariType||a.circuit||"Safari Package"}function p(a,t="",i){return a!=null&&a.length?a.map((s,l)=>`
