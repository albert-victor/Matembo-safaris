import"./tokens-9OgEy3cj.js";/* empty css                */import{b as c,r as v,a as $,i as S}from"./render-home-BvSrwE3U.js";/* empty css                       */import{renderWhatsAppFloat as w}from"./render-home-sections-CSIYOrLx.js";import{i as q}from"./scroll-reveal-BxdqyS58.js";import"./paths-BeSZcpY7.js";import"./destinations-data-DBODsxHG.js";import"./content-utils-YZbAt33H.js";import"./autoslider-93kM0AiT.js";import"./card-motion-gKtUt7p7.js";import"./render-cards-CN1Xy30p.js";import"./safari-packages-CU_z_aDq.js";function n(a){const e=document.createElement("div");return e.textContent=a,e.innerHTML}function s(a,e){return`
  ...
  `)}function W(){const a=document.querySelector("#safari-enquiry-form");if(!a)return;const e=new Date().toISOString().split("T")[0],t=a.querySelector('[name="arrival"]'),i=a.querySelector('[name="departure"]');t==null||t.setAttribute("min",e),i==null||i.setAttribute("min",e),t==null||t.addEventListener("change",()=>{t.value&&(i==null||i.setAttribute("min",t.value))}),a.addEventListener("submit",p=>{p.preventDefault();const o=new FormData(a),m=o.get("arrival"),f=o.get("departure"),u=o.get("name"),_=o.get("email"),h=o.get("phone")||"Not provided",r=o.get("safariType"),l=o.get("groupSize"),b=o.get("message")||"",y=encodeURIComponent(`Safari enquiry – ${r} (${l})`),g=encodeURIComponent(`Name: ${u}
Email: ${_}
Phone: ${h}
