import{g as _,s as u}from"./safari-packages-B2QcG3ea.js";import{t as v,l as h,u as k,r as m,a as f,i as p}from"./render-home-V4yjOGkn.js";import{initSlideshows as y}from"./slideshow-B52kY28T.js";import{i as $}from"./scroll-reveal-6DLuizO8.js";import{initCardTilt as b}from"./card-tilt-hVmWyP2d.js";function i(e){const a=document.createElement("div");return a.textContent=e??"",a.innerHTML}function w(e){const a=typeof e=="string"?e:e.id;return`/packages/${encodeURIComponent(a)}.html`}function S(e){return e.safariType||e.circuit||"Safari Package"}function x(e){var o;const a=h(e.overview),t=k(e.overview,e.activities),r=a.slice(0,3).map((s,c)=>c===0?`<p class="pkg-section__text pkg-section__text--lead">${i(s)}</p>`:`<p class="pkg-section__text">${i(s)}</p>`).join(""),l=t.length>0?`
      ...
      `:"";return`${r}${l}`}function P(e){return e!=null&&e.length?`
  ...
  `:""}function I(e,a=3){const t=_(e),r=t==null?void 0:t.circuit,l=u.filter(c=>c.id!==e);return[...l.filter(c=>c.circuit===r),...l.filter(c=>c.circuit!==r)].slice(0,a)}function L(e,a){var c;const t=document.querySelector(e);if(!t||!a)return!1;const{hero:r,extras:l}=v(a,3),o=I(a.id,3);document.title=`${a.title} | Matembo Safari & Tours`;const s=document.querySelector('meta[name="description"]');return s&&s.setAttribute("content",((c=h(a.overview)[0])==null?void 0:c.slice(0,155))||`${a.title} – ${a.duration} safari with Matembo Safari & Tours.`),t.innerHTML=`
    <article class="pkg-page">
      <header class="pkg-page__hero">
        <div class="pkg-page__hero-media">
          <img src="${i(r.src)}" alt="${i(r.alt)}" width="1600" height="680" loading="eager" decoding="async" />
        ...
        <div class="container pkg-page__hero-inner section-reveal">
          ...
          <ul class="pkg-page__pills" aria-label="Highlights">
            ${a.highlights.slice(0,3).map(n=>`<li>${i(n)}</li>`).join("")}
          </ul>
        ...
        <section class="pkg-page__related" aria-labelledby="related-safaris-title">
          <div class="container">
            ...
            <div class="pkg-page__related-grid">
              ${o.map(n=>`
                <a class="pkg-page__related-card section-reveal" href="${w(n)}">
                  <img src="${i(n.image)}" alt="${i(n.alt||n.title)}" loading="lazy" width="400" height="260" />
                  <span class="pkg-page__related-body">
                    <span class="pkg-page__related-meta">${i(n.duration)}</span>
                    <span class="pkg-page__related-title">${i(n.title)}</span>
                  </span>
                </a>
              `).join("")}
            </div>
