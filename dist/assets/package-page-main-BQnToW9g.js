import{b as _,s as u}from"./safari-packages-CU_z_aDq.js";import{a as v,s as h,b as m}from"./content-utils-YZbAt33H.js";import{r as k,a as f,i as d}from"./render-home-DlUWSJjl.js";import{initSlideshows as $}from"./slideshow-BEvNnOa7.js";import{i as y}from"./scroll-reveal-BxdqyS58.js";import{initCardTilt as b}from"./card-tilt-C-GpDV49.js";function i(a){const e=document.createElement("div");return e.textContent=a??"",e.innerHTML}function w(a){const e=typeof a=="string"?a:a.id;return`/packages/${encodeURIComponent(e)}.html`}function S(a){return a.safariType||a.circuit||"Safari Package"}function x(a){var o;const e=h(a.overview),t=m(a.overview,a.activities),n=e.slice(0,3).map((s,r)=>r===0?`<p class="pkg-section__text pkg-section__text--lead">${i(s)}</p>`:`<p class="pkg-section__text">${i(s)}</p>`).join(""),l=t.length>0?`
