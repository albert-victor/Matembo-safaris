import{n as m}from"./render-home-DLbeZLdX.js";function s(a){const e=document.createElement("div");return e.textContent=a,e.innerHTML}function n(a){return`/destinations/${encodeURIComponent(a.id)}.html`}function l(a,e="",d=0){const i=d<8;return a.map((t,c)=>{const r=i&&c===0,o=r?`src="${s(t.src)}" decoding="async"`:`data-src="${s(t.src)}" src="" loading="lazy" decoding="async"`;return`
