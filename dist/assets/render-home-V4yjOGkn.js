const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/mega-menu-hydrate-BiajXPPA.js","assets/paths-BeSZcpY7.js","assets/scroll-reveal-6DLuizO8.js","assets/destinations-data-D-DgQGhw.js","assets/circuits-page-data-tkaUj7lL.js","assets/safari-packages-B2QcG3ea.js"])))=>i.map(i=>d[i]);
import{_ as z,p as L}from"./paths-BeSZcpY7.js";import{l as be}from"./scroll-reveal-6DLuizO8.js";import{g as ue}from"./destinations-data-D-DgQGhw.js";const we="/assets/about/descriptions.jpg",ye="/assets/about/Matembo logo.jpg",Z={name:"Matembo Safari & Tours",tagline:"Safari & Tours"},ke=[{label:"Home",href:"/",plain:!0},{label:"Destinations",href:"/circuits.html",megaKey:"destinations"},{label:"Safaris",href:"/safaris.html",megaKey:"safaris"},{label:"Things to Do",href:"/experiences.html",megaKey:"thingsToDo"},{label:"Ruaha",href:"/ruaha-safaris.html",megaKey:"ruaha"},{label:"About Us",href:"/about.html",megaKey:"about"}],Y="/assets/about/main3.jpg",Se={ruaha2d:"/assets/photos/Ruaha_National_Park_Ruaha_River_42.jpg",ruaha3d:"/assets/photos/Ruaha_National_Park_Ruaha_River_39.jpg",ruaha4d:"/assets/photos/Ruaha_National_Park_Hippos_47.jpg",ruaha5d:"/assets/photos/Ruaha_National_Park_Elephants_49.jpg",ruaha7d:"/assets/photos/Udzungwa_National_Park_Sanje_Waterfalls_21.jpg",ruaha10d:"/assets/photos/Nyerere_National_Park_Lions_102.jpg",serengeti3d:"/assets/photos/Serengeti_Wildebeests_03.jpg",ngorongoroDay:"/assets/photos/Ngorongoro_Crater_01_NCA.jpg",tarangireDay:"/assets/photos/Tarangire_National_Park_Lions_20.jpg",serengeti5d:"/assets/photos/Serengeti_National_Park_Wildebeests_20.jpg",lemosho7d:"/assets/photos/Kilimanjaro_Trek_Lemosho_Route_04.jpg",machame8d:"/assets/photos/Kilimanjaro_Climb_Machame_Route_03.jpg",shiraDay:"/assets/photos/Kilimanjaro_Climb_Shira_Plateau_02.jpg",walkingSafaris:"/assets/about/walking safaris.jpg",migration:"/assets/photos/Serengeti_Wildebeests_03.jpg",olduvai:"/assets/photos/Olduvai_Gorge_NCA_2_1.jpg",udzungwa:"/assets/photos/Udzungwa_National_Park_Sanje_Waterfalls_21.jpg"};function Me(e){const a=e.getAttribute("data-fallback")||Y;e.dataset.fallbackApplied||(e.dataset.fallbackApplied="1",e.src=a)}function Ae(e=document){e.querySelectorAll(".mega-menu img, .site-header__brand-emblem").forEach(a=>{a.dataset.fallbackBound||(a.dataset.fallbackBound="1",a.addEventListener("error",()=>{if(a.hasAttribute("data-src"))return;const t=a.dataset.srcOriginal;if(t&&a.src.includes("/images/made/")&&!a.dataset.retriedOriginal){a.dataset.retriedOriginal="1",a.src=t;return}if(t&&!a.dataset.retriedOriginal&&a.src!==t){a.dataset.retriedOriginal="1",a.src=t;return}Me(a)}))})}function C(e){const a=document.createElement("div");return a.textContent=e,a.innerHTML}function je(e){if(e.plain)return`
      <li class="site-nav__item">
        <a class="site-nav__trigger site-nav__trigger--plain" href="${C(e.href)}">${C(e.label)}</a>
      </li>
    `;const a=e.href?"a":"button",t=e.href?` href="${C(e.href)}"`:"",r=e.href?"":' type="button"';return`
    <li class="site-nav__item" data-mega-slot="${C(e.megaKey)}">
      <${a}
  ...
  `}function Te(){const e=ke.map(je).join("");return`
    <header class="site-header is-over-hero" data-site-header>
      <div class="site-header__bar">
        <div class="container site-header__inner">
          <a class="site-header__brand" href="/" aria-label="${C(Z.name)} home">
            ...
            <span class="site-header__brand-lockup">
              ...
              <span class="site-header__brand-sub">${C(Z.tagline)}</span>
            </span>
          </a>
  ...
  `}function ia(e,a){return`
    <article
      ...
      data-hero-panel="${a}"
      data-text-layout="${f(e.textLayout||"center")}"
    ...
    >
      ...
      <a href="${fe(e.cta.href)}" class="btn btn--ghost hero-showcase__cta">${h(e.cta.label)}</a>
    </article>
  `}function ra(e,a){return`
    <button
      type="button"
      class="hero-showcase__dot${a===0?" is-active":""}"
      data-hero-dot="${a}"
      aria-label="Show ${f(e.title)}"
      aria-selected="${a===0?"true":"false"}"
    ></button>
  `}function _e(e=document.querySelector("#home-hero")){const a=e==null?void 0:e.querySelector("[data-hero-slideshow]");if(!a)return;const t=a.querySelector(".hero-showcase__slides"),r=a.querySelector(".hero-showcase__panels"),s=a.querySelector(".hero-showcase__dots"),o=a.querySelector("[data-hero-counter]"),l=a.querySelector("[data-hero-progress]");if(!t||!r||!s)return;const n=t.querySelectorAll("[data-hero-slide]").length;if(n>=k.length)return;const c=String(k.length).padStart(2,"0");for(let d=n;d<k.length;d++)t.insertAdjacentHTML("beforeend",ta(k[d],d)),r.insertAdjacentHTML("beforeend",ia(k[d],d)),s.insertAdjacentHTML("beforeend",ra(k[d],d));o&&(o.textContent=`01 / ${c}`),l&&(l.style.width=`${Math.round(100/k.length)}%`)}function sa(){var l;const e=document.querySelector("#home-hero");if(!e)return;if(e.querySelector("[data-hero-slideshow]")){_e(e);return}(l=e.querySelector("#hero-lcp-bootstrap"))==null||l.remove();const a=String(k.length).padStart(2,"0"),t=k.map((n,c)=>`
        <div
          class="hero-showcase__slide${c===0?" is-active":""}"
          data-hero-slide="${c}"
          data-motion="${f(n.motion||"zoom-in")}"
        >
          <img
            class="hero-showcase__img${c===0?" is-loaded":""}"
            ${c===0?`src="${f(n.image)}" fetchpriority="high"`:`data-src="${f(n.image)}" src=""`}
            alt="${f(n.imageAlt)}"
            width="1920"
            height="1080"
      ...
      `).join(""),r=Array.from({length:5},(n,c)=>`<span class="hero-showcase__particle" style="--i:${c}"></span>`).join(""),s=k.map((n,c)=>`
        <article
          ...
          data-hero-panel="${c}"
          data-text-layout="${f(n.textLayout||"center")}"
        ...
        >
          ...
          <a href="${fe(n.cta.href)}" class="btn btn--ghost hero-showcase__cta">${h(n.cta.label)}</a>
        </article>
      `).join(""),o=k.map((n,c)=>`
        <button
          type="button"
  ...
  `}function oa(){const e=document.querySelector("#home-about");e&&(e.innerHTML=`
    <section class="home-about" id="about" aria-labelledby="about-title">
      <div class="container home-about__grid">
        ...
        <div class="home-about__content section-reveal">
          ...
          <span class="home-about__script">${h(W.scriptLabel)}</span>
          <h2 id="about-title" class="home-section__title">${h(W.title)}</h2>
          ${W.paragraphs.map((a,t)=>`<p class="home-about__text"${t?` data-reveal-delay="${Math.min(t,2)}"`:""}>${h(a)}</p>`).join("")}
  ...
  `)}function na(){const e=document.querySelector("#home-experiences");e&&(e.innerHTML=`
    <section class="home-experiences" id="experiences" aria-labelledby="experiences-title">
      <div class="container">
        <header class="home-section__header section-reveal">
          ...
          <p class="home-section__desc">${h(Ye)}</p>
        </header>

        <div class="home-experiences__grid">
          ${Ke.map((a,t)=>`
                <article class="experience-card" data-reveal ${t%3?`data-reveal-delay="${t%3}"`:""}>
                  <span class="experience-card__icon" aria-hidden="true">${f(a.icon)}</span>
                  <h3 class="experience-card__title">${h(a.title)}</h3>
                  <p class="experience-card__text">${h(a.text)}</p>
                  ${a.href?`<a href="${f(a.href)}" class="experience-card__link">Explore →</a>`:""}
                </article>
              `).join("")}
        </div>
      </div>
    </section>
  `)}function la(){const e=document.querySelector("#home-credentials");e&&(e.innerHTML=`
        ...
        <dl class="credentials-grid">
          ${Ze.map((a,t)=>`
                <div class="credentials-grid__item" data-reveal ${t%3?`data-reveal-delay="${t%3}"`:""}>
                  <dt>${h(a.label)}</dt>
                  <dd>
                    ${a.href?`<a href="${f(a.href)}" target="_blank" rel="noopener noreferrer">${h(a.value)}</a>`:h(a.value)}
                  </dd>
                </div>
              `).join("")}
        </dl>
  ...
  `)}function ca(){const e=document.querySelector("#home-testimonials");e&&(e.innerHTML=`
    <section class="home-testimonials" id="testimonials" aria-labelledby="testimonials-title">
      <div class="container">
        <header class="home-section__header section-reveal">
          ...
          <p class="home-section__desc">${h(Qe)} <a href="${f(x)}" target="_blank" rel="noopener noreferrer"><i class="fab fa-tripadvisor" aria-hidden="true"></i> TripAdvisor</a>.</p>
        </header>

        <div class="testimonials-grid">
          ${Je.map((a,t)=>`
                <blockquote class="testimonial-card" data-reveal ${t?`data-reveal-delay="${t}"`:""}>
                  <div class="testimonial-card__stars" aria-label="${a.rating} out of 5 stars">${aa(a.rating)}</div>
  ...
  `)}function ha(){const e=document.querySelector("#home-contact");e&&(e.innerHTML=`
    <section class="home-contact" id="contact" aria-labelledby="contact-title">
      <div class="container home-contact__inner section-reveal">
        <span class="home-contact__script">${h(E.signature)}</span>
        <h2 id="contact-title" class="home-contact__title">${h(E.title)}</h2>
        <p class="home-contact__text">${h(E.text)}</p>
        <div class="home-contact__actions">
          <a href="${f(E.ctaPrimary.href)}" class="btn btn--primary">${h(E.ctaPrimary.label)}</a>
          <a href="${f(E.ctaSecondary.href)}" class="btn btn--secondary" target="_blank" rel="noopener noreferrer">${h(E.ctaSecondary.label)}</a>
        </div>
        <p class="home-contact__meta">${h($.location)} · ${h($.phone)}</p>
      </div>
    </section>
  `)}function ua(){const e=document.querySelector("#site-footer");if(!e)return;const a=Ve.map(t=>`
        <a
        ...
        >
          <i class="${f(t.icon)}" aria-hidden="true"></i>
        </a>
      `).join("");e.innerHTML=`
      ...
      <div class="site-footer__top">
        <div class="container site-footer__grid">
          <div class="site-footer__brand">
            ...
            <p class="site-footer__name">${h($.name)}</p>
          ...
          <nav class="site-footer__col" aria-label="Plan your trip">
            ...
            <a class="site-footer__link" href="${f(x)}" target="_blank" rel="noopener noreferrer">
          ...
          <div class="site-footer__col">
            ...
            <a class="site-footer__link" href="mailto:${f($.email)}">
      ...
      <div class="site-footer__social-bar">
        <div class="container site-footer__social-inner">
          ...
          <p class="site-footer__copyright">
            © ${new Date().getFullYear()} ${h($.name)}. Wildlife safaris across Tanzania.
          </p>
        </div>
      </div>
    </footer>
  `}const Ma=Object.freeze(Object.defineProperty({__proto__:null,enhanceHeroSlideshow:_e,renderAbout:oa,renderContactCta:ha,renderCredentials:la,renderExperiences:na,renderHero:sa,renderSiteFooter:ua,renderTestimonials:ca},Symbol.toStringTag,{value:"Module"}));export{F as D,Se as N,ua as a,$ as b,E as c,D as d,f as e,h as f,ge as g,N as h,pa as i,B as j,me as k,ya as l,Ge as m,va as n,_a as o,wa as p,sa as q,fa as r,Ve as s,Sa as t,ka as u,Ae as v,Ie as w,ba as x,Ma as y};
