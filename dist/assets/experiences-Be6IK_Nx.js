import"./tokens-9OgEy3cj.js";/* empty css                */import{g as l,h as m,r as _,a as g,i as h,n as p}from"./render-home-DlUWSJjl.js";/* empty css                     */import{p as v}from"./content-utils-YZbAt33H.js";import{a as u,i as $}from"./scroll-reveal-BxdqyS58.js";import{initSlideshows as f}from"./slideshow-BEvNnOa7.js";import"./paths-BeSZcpY7.js";import"./destinations-data-DBODsxHG.js";function i(e){const a=document.createElement("div");return a.textContent=e,a.innerHTML}function y(e,a){var r;const t=a%3,s=((r=e.highlights)==null?void 0:r.slice(0,2))||[],d=v(e,1)[0]||e.images[0];return`
  ...
  `}function L(e){const a=document.querySelector(e);a&&(a.innerHTML=l.map((t,s)=>y(t,s)).join(""))}function n(e){const a=document.createElement("div");return a.textContent=e,a.innerHTML}function S(){const e=document.querySelector("#things-to-do-index");e&&(e.innerHTML=p.map(a=>`
      ...
      `).join(""))}function c(){_(),g(),S(),L("#experiences-grid"),h(),u(),f(),$()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",c):c();
