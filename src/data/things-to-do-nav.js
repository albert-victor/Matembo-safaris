...
export const thingsToDoColumns = [
  [
    ...
    { name: "Bird Watching", href: "/bird-watching.html" },
    { name: "Walking / Hiking", href: "/experiences/hiking.html" },
    { name: "Cultural Visits", href: "/cultural-visits.html" },
  ...
  [
    ...
    { name: "Chimpanzee Watching", href: "/activities/chimpanzee-watching.html" },
    { name: "Night Game Drives", href: "/night-game-drives.html" },
...
export const ACTIVITY_DEFINITIONS = [
  ...
  { slug: "night-game-drives", label: "Night Game Drives" },
  { slug: "cultural-visits", label: "Cultural Visits" },
