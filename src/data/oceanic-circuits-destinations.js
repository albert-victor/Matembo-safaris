...
export const oceanicCircuitMeta = {
  ...
  sourceUrl: "https://www.tanzaniatourism.com/destinations/ocean-islands",
};
...
export const oceanicCircuitDestinations = [
    {
      id: "mbudya-island-marine-reserve",
      slug: "mbudya-island-marine-reserve",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Mbudya Island Marine Reserve",
      fullName: "Mbudya Island Marine Reserve",
      scriptLabel: "Marine Discovery",
    ...
    {
      id: "bongoyo-island-marine-reserve",
      slug: "bongoyo-island-marine-reserve",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Bongoyo Island Marine Reserve",
      fullName: "Bongoyo Island Marine Reserve",
      scriptLabel: "Marine Discovery",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Beach Holiday",
      bestSeason: "Jun – Mar",
    ...
    {
      id: "pangavini-island-marine-reserve",
      slug: "pangavini-island-marine-reserve",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Pangavini Island Marine Reserve",
      fullName: "Pangavini Island Marine Reserve",
      scriptLabel: "Marine Discovery",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Beach Holiday",
      bestSeason: "Jun – Mar",
    ...
    {
      id: "fungu-yasin-sand-bar",
      slug: "fungu-yasin-sand-bar",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Fungu Yasin Sand Bar",
      fullName: "Fungu Yasin Sand Bar",
      scriptLabel: "Coastal Discovery",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Beach Holiday",
      bestSeason: "Jun – Mar",
      ...
      descriptions: [
        ...
        "Coral reefs are found on the western and eastern side of the Island where more than 35% of coral cover is located on two locations: one on the southwest waters of less than 10 m (108,320 m 2 ) and the other on the deeper waters (462,765 m 2 ).",
    ...
    {
      id: "sinda-island-marine-reserve",
      slug: "sinda-island-marine-reserve",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Sinda Island Marine Reserve",
      fullName: "Sinda Island Marine Reserve",
      scriptLabel: "Marine Discovery",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Beach Holiday",
      bestSeason: "Jun – Mar",
    ...
    {
      id: "maziwe-island-marine-reserve",
      slug: "maziwe-island-marine-reserve",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Maziwe Island Marine Reserve",
      fullName: "Maziwe Island Marine Reserve",
      scriptLabel: "Marine Discovery",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Beach Holiday",
      bestSeason: "Jun – Mar",
      ...
      descriptions: [
        ...
        "Attractions Species of fish : In Maziwe Marine reserve you will find over 200 species of fish and 35 kinds of coral reefs which are found in the particular area.",
        ...
        "Climate Rainfall - The coastal has tropical climate and it contain about two main rain seasons but heavy rains occurs between mid-march to May. Temperature - The temperatures average between 25°C to 30°C",
      ],
      highlights: [
        "Marine life & reefs",
        "Beaches & coast",
    ...
    {
      id: "ulenge-island-marine-reserve",
      slug: "ulenge-island-marine-reserve",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Ulenge Island Marine Reserve",
      fullName: "Ulenge Island Marine Reserve",
      scriptLabel: "Marine Discovery",
      region: "Indian Ocean Tanzania",
      ...
      descriptions: [
        "Ulenge Island or Ulenge Island Marine Reserve is a 3.151 km 2 protected, seasonally inhabited island in the Pemba Channel under the Tanga Marine Reserves (TMRS) with the IUCN category II bordering Tanga Bay and Kwale Bay at the north of Tanga. Ulenge Island is nicknamed as Bird Island due to its importance as a seabird sanctuary and contains a diverse range of bird species, including Greater Sand Plover, Curlew Sandpiper, Crab Plover, Migrating Waders, and many more. Ulenge Island is also bordered by a healthy coral reef that offers great snorkeling and diving over its shallow reef crest and down into the drop off the Pemba channel.",
    ...
    {
      id: "kwale-island-marine-reserve",
      slug: "kwale-island-marine-reserve",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Kwale Island Marine Reserve",
      fullName: "Kwale Island Marine Reserve",
      scriptLabel: "Marine Discovery",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Tourist Attractions",
      bestSeason: "Jun – Mar",
    ...
    {
      id: "kirui-island-marine-reserve",
      slug: "kirui-island-marine-reserve",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Kirui Island Marine Reserve",
      fullName: "Kirui Island Marine Reserve",
      scriptLabel: "Marine Discovery",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Tourist Attractions",
      bestSeason: "Jun – Mar",
      ...
      descriptions: [
        "Kirui Island or Kirui Island Marine Reserve is a 36.095 km 2 protected, uninhabited island in the Pemba Channel under the Tanga Marine Reserves (TMRS) with the IUCN category II located within Mkinga District in Tanga. The Island is the largest in Tanga and one of the largest protected marine Islands in Tanzania Mangroves are thought to cover 680 ha (ha) of the island of Kirui, with the largest mangrove area (557 ha) being on the north also the Tanzania‐Kenya border and west sides, Kigomeni mangrove (60 ha) being on the east coast, and Kirui South Mangrove (63 ha) being on the south.",
    ...
    },
    {
      ...
      circuitLabel: "Ocean Islands",
      name: "Yambe Island",
      fullName: "Yambe Island",
      scriptLabel: "Island Escape",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Beach Holiday",
      bestSeason: "Jun – Mar",
      journeys: "0 tours · 142 reviews",
    ...
    {
      id: "mwewe-island-marine-reserve",
      slug: "mwewe-island-marine-reserve",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Mwewe Island Marine Reserve",
      fullName: "Mwewe Island Marine Reserve",
      scriptLabel: "Marine Discovery",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Tourist Attractions",
      bestSeason: "Jun – Mar",
      ...
      descriptions: [
        "Mwewe Island or Mwewe Island Marine Reserve is a 0.424 km 2 protected, uninhabited island in the Pemba Channel under the Tanga Marine Reserves (TMRS) with the IUCN category II located within Mkinga District in Tanga. According to oral Digo history, the island was used by some Kirui Island residents, at one time Mwewe Island was eventually purchased by Sultan Bin Athmani of Moa before being a Marine Reserve. Mwewe Island is also surrounded by mangroves, which covers an area of 14 Ha, about 68 % of the Island.",
      ],
      highlights: [
        "Marine life & reefs",
        "Nature & wildlife",
    ...
    {
      id: "chumbe-island-marine-sanctuary",
      slug: "chumbe-island-marine-sanctuary",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Chumbe Island Marine Sanctuary",
      fullName: "Chumbe Island Marine Sanctuary",
      scriptLabel: "Marine Discovery",
      region: "Indian Ocean Tanzania",
    ...
    {
      id: "mnemba-island-conservation-area",
      slug: "mnemba-island-conservation-area",
      circuit: "oceanic",
      circuitLabel: "Ocean Islands",
      name: "Mnemba Island Conservation Area",
      fullName: "Mnemba Island Conservation Area",
      scriptLabel: "Island Escape",
      region: "Indian Ocean Tanzania",
      category: "Ocean Islands | Beach Holiday",
      bestSeason: "Jun – Mar",
      ...
      descriptions: [
        ...
        "Diving & Snorkeling Sites Around Northern Zanzibar Island and Mnemba Island Marine Conservation Area Diving at Mnemba is a year-round event, with reasonably good conditions to be found on the atoll under almost all weather conditions and visibilities of 20 to 40 metres are the norm.",
